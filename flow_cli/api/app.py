...
from flow_cli.api.routes import health, openai, setup
...
async def _lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    from flow_cli.token_updater.browser import browser_manager
    from flow_cli.token_updater.config import config as updater_config
    from flow_cli.token_updater.database import profile_db
    from flow_cli.token_updater.logger import logger as updater_logger
    from flow_cli.token_updater.updater import token_syncer
    ...
    from flow_cli.captcha_service.main import startup_captcha_service
    ...
    from flow_cli.captcha_service.main import shutdown_captcha_service
    ...
    from flow_cli.api.login_manager import login_manager
...
def create_app() -> FastAPI:
    ...
    from flow_cli.captcha_service.api import (
    ...
    from flow_cli.token_updater.api import app as token_updater_app
    ...
    async def portal_page() -> FileResponse:
        ...
        from flow_cli.captcha_service.core.config import config as captcha_config
