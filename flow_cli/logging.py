"""
Structured logging configuration for flow_cli.
...
def setup_logging(
    *,
    ...
    """Configure the ``flow_cli`` root logger.
    ...
    root = logging.getLogger("flow_cli")
    root.setLevel(level)
...
def get_logger(name: str) -> logging.Logger:
    """Return a child logger under the ``flow_cli`` namespace.
    ...
    setup_logging()
    return logging.getLogger(f"flow_cli.{name}")
