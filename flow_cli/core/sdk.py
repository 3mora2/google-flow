"""
Unified High-Level SDK for programmatic flow_cli usage.
"""
...
class FlowSDK:
    """High-level Unified SDK for programmatic use of flow_cli.
    ...
    async def __aenter__(self) -> FlowSDK:
        from flow_cli.config import get_config, set_config
        ...
        if self.captcha_provider is None:
            from flow_cli.captcha.in_process_provider import (
            ...
            try:
                ...
                from flow_cli.captcha.base import NullCaptchaProvider
    ...
    async def __aexit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None:
        ...
        from flow_cli.config import set_config
